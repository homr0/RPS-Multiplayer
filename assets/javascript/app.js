$(document).ready(function() {
    ...
    function finishGame() {
        ...
        // Clears the autogenerated messages
        database.ref("chat").orderByChild("uid").equalTo("autoGM").once("value").then(function(dialog) {
            console.log(dialog.val());
            $(dialog.val()).each(function(index, value) {
                console.log(value);
                let chatKey = Object.keys(value)[index];
                console.log(chatKey);
                database.ref("chat/" + chatKey).remove();
            });
        });
        
        // Goes through the chat log for the autoGM and removes them.
        $(".chat[data-uid='autoGM'").remove();
    }
